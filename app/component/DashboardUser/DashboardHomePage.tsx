                ...
                <>
                  ...
                  <table className="w-full text-sm">
                    <thead className="sticky top-0 bg-white">
                      <tr className="text-left text-xs text-gray-400 border-b border-gray-100">
                        ...
                        <th
                          className="px-5 py-3 font-medium text-right"
                          title="ราคาปิดล่าสุดของหุ้นตัวนี้ตามตลาด (อัปเดตรายวัน) — พักไว้เฉพาะการแสดงผล ไม่ใช่ตัวเลขเพื่อคำนวณภาษี"
                        >
                          ราคาปัจจุบัน
                        </th>
                        <th
                  ...
                  <div className="px-5 py-2.5 border-t border-gray-50">
                    <p className="text-[11px] text-gray-400">
                      ...
                      ตลาด (อัปเดตรายวัน) — แสดงผลประกอบ ไม่เกี่ยวข้องกับการคำนวณ
                       ฐานภาษี · คลิกที่สัญลักษณ์เพื่อดูรายละเอียดหุ้นรายตัว ·
